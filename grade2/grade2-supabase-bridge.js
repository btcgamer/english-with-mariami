...
function loadExpansion(){if(document.querySelector('script[data-grade2-content-expansion]'))return;const s=document.createElement('script');s.src='grade2-content-expansion.js?v=20260901';s.async=true;s.dataset.grade2ContentExpansion='1';document.head.appendChild(s)}
