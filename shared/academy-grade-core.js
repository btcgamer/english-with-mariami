...
<section class="card activity"><h2>✍️ Writing / Practice</h2><p class="question">${esc(think)}</p><textarea class="answer" placeholder="Write 2–4 English sentences..."></textarea></section>
