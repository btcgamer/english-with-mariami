...
const G1=[['Alphabet & Greetings'],['Numbers'],['Colors & Shapes'],['Family & People'],['My Body'],['Animals'],['Birds & Nature'],['School'],['Home'],['Food & Drinks'],['Weather & Seasons'],['About Me & Review']];
const fallbackWorlds=grade===1?G1:G2;
const lesson=n=>fallbackWorlds[Math.floor((n-1)/5)%fallbackWorlds.length];
